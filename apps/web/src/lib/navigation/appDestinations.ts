...
export const APP_DESTINATIONS: readonly AppDestination[] = [
  ...
  },
  {
    ...
    icon: IconListCheck,
    keywords: ["schedule", "planner", "wizard", "timetable", "generate"],
    navKey: "s",
  },
  {
    id: "calendar",
    to: "/schedule/calendar",
    labelId: "app.nav.dest.calendar.label",
    descriptionId: "app.nav.dest.calendar.description",
    icon: IconCalendar,
    keywords: ["calendar", "timetable", "schedules", "week"],
    navKey: "c",
  },
  {
    id: "trends",
