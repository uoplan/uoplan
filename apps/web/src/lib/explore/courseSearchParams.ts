import { normalizeCourseCode, type NormalizedCourseCode } from "@uoplan/core";
...
export function parseCoursePathParam(raw: string | undefined): NormalizedCourseCode | null {
