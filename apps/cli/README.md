...
Execute a schedule payload generated by the [uoplan web app](https://uoplan.ca). Paste the Base64url-encoded payload from the site to automatically enrol in the courses it describes.
