...
export const SCENES = [
  {
    ...
    pose: { x: 0.0, y: -0.2, s: 1.0, yaw: -16, tilt: 9, roll: 0 },
    text: {
      side: "right",
      anim: "slideR",
      pre: "explore every",
  ...
  },
  {
    ...
    pose: { x: 0.2, y: -0.2, s: 1.02, yaw: 14, tilt: 9, roll: 0 },
    text: {
      side: "left",
      anim: "slideL",
      pre: "a decade of",
  ...
  },
  {
    ...
    pose: { x: 0.0, y: -0.1, s: 1.04, yaw: -8, tilt: 7, roll: 0 },
    text: {
      side: "right",
      anim: "rise",
  ...
  },
  {
    ...
    pose: { x: -1.9, y: -0.5, s: 1.16, yaw: 22, tilt: 7, roll: 7 },
  ...
  },
  {
    ...
    pose: { x: 0.0, y: 0.4, s: 0.92, yaw: -8, tilt: 5, roll: -3 },
    text: { side: "center", place: "below", anim: "rise", pre: "and on", flip: ["iPadOS"] },
  },
];
