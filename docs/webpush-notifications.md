...
1. GitHub Action runs `pnpm --filter scraper check:terms` (fetches uOttawa's class search page, syncs `apps/scraper/data/uottawa/terms.json` to match the live dropdown, and reports any newly added term IDs)
