...
import type { BlockedTimeWindow, GenerationConstraints } from "../generation/types";
...
export function decodedState(over: Partial<DecodedState> = {}): DecodedState {
  return {
    ...
    levelBuckets: [] as CourseLevelBucket[],
    languageBuckets: [] as CourseLanguageBucket[],
    ...
    blacklistedCourses: [],
    blockedTimes: [] as BlockedTimeWindow[],
    ...over,
  };
}
