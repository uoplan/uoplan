...
const catalogue: Catalogue = {
  courses: [
    ...
    {
      code: normalizeCourseCode("PHI 2101"),
      title: "Mid",
      credits: 3,
      description: "",
      component: "Lecture",
    ...
    {
      code: normalizeCourseCode("PHI 3101"),
      title: "Upper",
      credits: 3,
      description: "",
      component: "Lecture",
    ...
    {
      code: normalizeCourseCode("PHI 4101"),
      title: "Senior",
      credits: 3,
      description: "",
      component: "Lecture",
    ...
    {
      code: normalizeCourseCode("BIG 1000"),
      title: "Big",
      credits: 6,
      description: "",
      component: "Lecture",
...
describe("resolveElectiveCandidates levels filtering", () => {
  ...
  it("returns all credit-eligible courses when no levels constraint", () => {
    ...
    expect(result.sort()).toEqual([
      ...
      normalizeCourseCode("PHI 2101"),
      normalizeCourseCode("PHI 3101"),
      normalizeCourseCode("PHI 4101"),
    ]);
  });
  ...
  it("applies levels alongside the credit ceiling", () => {
    ...
    expect(result.sort()).toEqual([normalizeCourseCode("PHI 1101")]);
  });
});
