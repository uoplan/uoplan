...
import { defaultOptimizationPriorities, setOptimizationPriorityEnabled } from "@uoplan/core";
...
describe("clearGenerationOptions", () => {
  it("resets generation options to defaults while preserving program/completed courses", () => {
    ...
    store.setState({
      ...
      optimizationPriorities: setOptimizationPriorityEnabled(
    ...
    expect(s.optimizationPriorities).toEqual(defaultOptimizationPriorities());
