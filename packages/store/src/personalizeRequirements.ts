...
import type { Catalogue, DisciplinesData, Program, SchedulesData } from "@uoplan/domain/dataTypes";
...
import type { AdvancedRequestInput } from "@uoplan/generation/engineBridge";
import {
  computeRequirementAutoAssignment,
  getDisciplineCodesForProgram,
} from "@uoplan/generation/generation/requirementAutoAssign";
import {
