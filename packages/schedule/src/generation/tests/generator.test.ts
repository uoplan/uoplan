...
describe("generator", () => {
        ...
        LEC: [
          {
            ...
            meetingDates: null,
            times: [
              { startMinutes: 600, endMinutes: 690, day: "Mo", virtual: false },
              { startMinutes: 600, endMinutes: 690, day: "We", virtual: false },
            ],
          },
          {
            section: "B",
            ...
            meetingDates: null,
            times: [
              { startMinutes: 900, endMinutes: 990, day: "Tu", virtual: false },
              { startMinutes: 900, endMinutes: 990, day: "Th", virtual: false },
            ],
          },
        ],
        DGD: [
          {
            ...
            instructors: [],
            meetingDates: null,
            times: [{ startMinutes: 720, endMinutes: 810, day: "Fr", virtual: false }],
          },
          {
            section: "A",
            sectionCode: "A02",
            ...
            instructors: [],
            meetingDates: null,
            times: [{ startMinutes: 840, endMinutes: 930, day: "Fr", virtual: false }],
          },
        ],
      },
    },
        ...
        LEC: [
          {
            ...
            instructors: [],
            meetingDates: null,
            times: [{ startMinutes: 600, endMinutes: 690, day: "Mo", virtual: false }],
          },
          {
            section: "B",
            sectionCode: "B00",
            ...
            instructors: [],
            meetingDates: null,
            times: [{ startMinutes: 1020, endMinutes: 1110, day: "Mo", virtual: false }],
          },
        ],
        TUT: [
          {
            ...
            instructors: [],
            meetingDates: null,
            times: [{ startMinutes: 900, endMinutes: 990, day: "We", virtual: false }],
          },
        ],
      },
    },
        ...
        LEC: [
          {
            ...
            instructors: [],
            meetingDates: null,
            times: [{ startMinutes: 480, endMinutes: 570, day: "Mo", virtual: false }],
          },
        ],
      },
    },
  ...
  describe("generateSchedules", () => {
    ...
    it("supports constraints (e.g. time filters)", () => {
      ...
      expect(
        schedules[0].enrollments.find((e) => e.courseCode === "CSI2110")?.sectionCombo["LEC"]
          ?.section.section,
      ).toBe("B");
      expect(
        schedules[0].enrollments.find((e) => e.courseCode === "SEG2105")?.sectionCombo["LEC"]
          ?.section.section,
      ).toBe("A");
    });
  ...
  describe("generateSchedulesWithPinned", () => {
    it("forces inclusion of pinned courses", () => {
      ...
      for (const s of schedules) {
        expect(
          s.enrollments.find((e: CourseEnrollment) => e.courseCode === "SEG2105"),
        ).toBeDefined();
      }
    });
    ...
    it("finds combinations properly when pinned overlaps some optional", () => {
      ...
      expect(
        schedules[0].enrollments.find((e: CourseEnrollment) => e.courseCode === "CSI2110")
          ?.sectionCombo["LEC"]?.section.section,
      ).toBe("B");
      expect(
        schedules[0].enrollments.find((e: CourseEnrollment) => e.courseCode === "SEG2105")
          ?.sectionCombo["LEC"]?.section.section,
      ).toBe("A");
    });

    it("falls back to standard generateSchedules if pinned is empty", () => {
      const schedulesWithPinnedEmpty = generateSchedulesWithPinned(
        [],
        ["CSI2110", "SEG2105"],
        2,
        mockCache,
