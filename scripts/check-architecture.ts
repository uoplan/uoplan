...
const LAYERS: Record<string, string[]> = {
  ...
  "@uoplan/grades": ["@uoplan/proto", "@uoplan/domain", "@uoplan/professors"],
  "@uoplan/professors": ["@uoplan/proto", "@uoplan/domain"],
  "@uoplan/requirements": ["@uoplan/domain"],
  "@uoplan/generation": [
    "@uoplan/proto",
    "@uoplan/domain",
    "@uoplan/grades",
  ...
  "@uoplan/ics": ["@uoplan/domain", "@uoplan/generation"],
  "@uoplan/state-codec": [
    "@uoplan/proto",
    "@uoplan/domain",
    "@uoplan/generation",
